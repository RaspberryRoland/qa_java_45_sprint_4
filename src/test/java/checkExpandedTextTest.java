...
public class checkExpandedTextTest {
    ...
    private final String expectedTextValue;
    private WebDriver driver;

    public checkExpandedTextTest(int number, String expectedTextValue) {
        this.number = number;
    ...
    public void checkExpandedText() throws Exception {
        ...
        Assert.assertTrue(mainPage.checkExpandedText(number, expectedTextValue));
    }
